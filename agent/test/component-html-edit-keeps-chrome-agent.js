// Per-probe copy for probe-component-html-edit-keeps-chrome — its own stub so no two probes share one.
...
const KIND = 'component-html-edit-keeps-chrome';
...
const ComponentHtmlEditKeepsChromeAgent = () => {
    const currentDebug = {
        kind: KIND,
...
module.exports = { ComponentHtmlEditKeepsChromeAgent };
