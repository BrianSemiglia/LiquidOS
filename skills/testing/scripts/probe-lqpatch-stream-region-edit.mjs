//
// probe-lqpatch-stream-region-edit.mjs
//
...
//
// Run it:  node run-probe.mjs probe-lqpatch-stream-region-edit.mjs
//

export const fixture = './probe-lqpatch-stream-region-edit.liquidos';
export const agent = 'agent/test/lqpatch-stream-region-stub-agent.js';
