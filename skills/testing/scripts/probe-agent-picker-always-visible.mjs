//
// probe-agent-picker-always-visible.mjs
//
...
//
// Run it:  node run-probe.mjs probe-agent-picker-always-visible.mjs
//

export const fixture = './probe-agent-picker-always-visible.liquidos';
