...
//
// Run it:  node run-probe.mjs probe-debug-output.mjs
//

export const fixture = './probe-debug-output.liquidos';
export const agent = 'agent/test/debug-output-agent.js';
