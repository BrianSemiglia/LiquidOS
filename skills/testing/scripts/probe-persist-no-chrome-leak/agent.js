// Per-probe copy for probe-persist-no-chrome-leak — its own stub so no two probes share one.
...
const KIND = 'persist-no-chrome-leak';
...
const PersistNoChromeLeakAgent = () => {
    const currentDebug = {
        kind: KIND,
...
module.exports = { PersistNoChromeLeakAgent };
