//
// probe-agent-persists-restart.mjs
//
...
//
// Run it:  node run-probe.mjs probe-agent-persists-restart.mjs
//

import { bootSandbox } from './sandbox.mjs';

export const fixture = null; // self-managed: two sequential boots, same workspace
const FIXTURE = new URL('./probe-agent-switch.liquidos', import.meta.url);
const AGENTS = [
    'agent/test/agent-switch-stub-a-agent.js', // first → default-active on a fresh boot
