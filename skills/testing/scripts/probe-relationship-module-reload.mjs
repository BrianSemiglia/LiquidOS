//
// probe-relationship-module-reload.mjs
//
...
//
// Run it:  node run-probe.mjs probe-relationship-module-reload.mjs
//

import fs from 'node:fs';
import path from 'node:path';

export const fixture = './probe-relationship-module-reload.liquidos';
