//
// probe-place-canvas-renders-component.mjs
//
...
//
// Run it:  node run-probe.mjs probe-place-canvas-renders-component.mjs
//

export const fixture = './probe-place-canvas-renders-component.liquidos';
