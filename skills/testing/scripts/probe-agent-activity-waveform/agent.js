// Per-probe copy for probe-agent-activity-waveform — its own stub so no two probes share one.
...
const KIND = 'agent-activity-waveform';
...
const AgentActivityWaveformAgent = () => {
    const currentDebug = {
        kind: KIND,
...
module.exports = { AgentActivityWaveformAgent };
