// Per-probe copy for probe-cancel-button-disables — its own stub so no two probes share one.
...
const KIND = 'cancel-button-disables';
...
const CancelButtonDisablesAgent = () => {
...
module.exports = { CancelButtonDisablesAgent };
