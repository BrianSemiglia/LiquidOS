//
// probe-component-module-reload.mjs
//
...
//
// Run it:  node run-probe.mjs probe-component-module-reload.mjs
//

import fs from 'node:fs';
import path from 'node:path';

export const fixture = './probe-component-module-reload.liquidos';
