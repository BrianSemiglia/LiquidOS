// Per-probe copy for probe-cancel-undo-precedes-queued — its own stub so no two probes share one.
...
const KIND = 'cancel-undo-precedes-queued';
...
const CancelUndoPrecedesQueuedAgent = () => {
...
module.exports = { CancelUndoPrecedesQueuedAgent };
