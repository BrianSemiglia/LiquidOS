...
//
// Run it:  node run-probe.mjs probe-sandbox-land.mjs
//

export const fixture = './probe-sandbox-land.liquidos';
export const agent = 'agent/test/sandbox-land-test-agent.js';
