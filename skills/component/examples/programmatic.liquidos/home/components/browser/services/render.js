...
const writeView = origin => {
  fs.writeFileSync(path.join(component, 'view.json'), JSON.stringify({ title: 'Todo Render Server', html: renderView(origin) }, null, 2));
  log('writeView', { origin, path: path.join(component, 'view.json') });
};
