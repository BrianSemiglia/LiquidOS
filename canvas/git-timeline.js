...
// The timeline's own run-loop lifecycle events. The agent turn is bracketed by
// a will/did pair: the "will" event is committed BEFORE the agent runs
// (snapshotting recoverable pre-state), the "did" event after. Domain events
// (canvases, components, …) are NOT defined here — callers build those with
// eventWithParameter, keeping the timeline ignorant of the data model.
